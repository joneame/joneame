...
function text_to_html($str, $hashtype = false, $do_links = true) {
    ...
    if ($do_links) {
        $str = preg_replace('/(\b)(https*:\/\/)(www\.){0,1}([^ \t\n\r\]\&]{5,70})([^ \t\n\r\]]*)([^ :.\t,\n\r\(\)\"\'\]\?])/u', '$1<a href="$2$3$4$5$6" title="$2$3$4$5$6" rel="nofollow noopener">$4$6</a>', $str);
    }
    if ($globals['buscador_activado'] && $hashtype) {
...
function normalize_smileys($str) {
    $str = preg_replace('/\B:ffu:\B/i', '{ffu}', $str);
    $str = preg_replace('/\B:clint:\B/i', '{clint}', $str);
    $str = preg_replace('/\B:nusenuse:\B/i', '{nuse}', $str);
    $str = preg_replace('/\B:gaydude:\B/i', '{gaydude}', $str);
    $str = preg_replace('/\B:yeah:\B/i', '{yeah}', $str);
    $str = preg_replace('/\B:fuckyeah:\B/i', '{yeah}', $str);
    $str = preg_replace('/\B:alone:\B/i', '{alone}', $str);
    $str = preg_replace('/\B:longcat:\B/i', '{longcat}', $str);
    $str = preg_replace('/\B:freising:\B/i', '{freising}', $str);
    $str = preg_replace('/\B:yaoface:\B/i', '{yaoface}', $str);
    $str = preg_replace('/\B:cejas:\B/i', '{cejas}', $str);
    $str = preg_replace('/\B:awesome:\B/i', '{awesome}', $str);
    $str = preg_replace('/\B:sisi1:\B/i', '{sisi}', $str);
    $str = preg_replace('/\B:sisi3:\B/i', '{sisitres}', $str);
    $str = preg_replace('/\B:roto2:\B/i', '{roto}', $str);
    $str = preg_replace('/\B:trollface:\B/i', '{trollface}', $str);
    $str = preg_replace('/\B:troll:\B/i', '{troll}', $str);
    $str = preg_replace('/\B:palm:\B/i', '{palm}', $str);
    $str = preg_replace('/\B:goat(se)?:\B/i', '{goatse}', $str);
    $str = preg_replace('/\B[:\(]8[:\)]\B/i', '{music}', $str);
    $str = preg_replace('/\bo_o\b|\B:wow:\B/i', '{wow}', $str);
    $str = preg_replace('/\B¬¬|:shame:\B/i', '{shame}', $str);
    $str = preg_replace('/\B:-?\)\B/', '{smiley}', $str);
    $str = preg_replace('/\B;-?\)\B/', '{wink}', $str);
    $str = preg_replace('/\B:-?>\B/', '{cheesy}', $str);
    $str = preg_replace('/\B:-?D\b|\B:grin:\B/i', '{grin}', $str);
    $str = preg_replace('/\B(:oops:|<:-?\()\B/i', '{oops}', $str);
    $str = preg_replace('/\B>:-?\(\B/', '{angry}', $str);
    $str = preg_replace('/\B\?(:-?)?\(\B/', '{huh}', $str);
    $str = preg_replace('/\B:-?O\b/i', '{shocked}', $str);
    $str = preg_replace('/\b8-?(D\b|\)\B)|\B:cool:\B/', '{cool}', $str);
    $str = preg_replace('/\B:roll:\B/i', '{roll}', $str);
    $str = preg_replace('/\B:-?P\b/i', '{tongue}', $str);
    $str = preg_replace('/\B:-?x\b/i', '{lipssealed}', $str);
    $str = preg_replace('/\B:-?\/\B/i', '{undecided}', $str);
    $str = preg_replace('/\B(:\'-?\(|:cry:)\B/i', '{cry}', $str);
    $str = preg_replace('/\bx-?D+\b|\B:lol:\B/i', '{lol}', $str);
    $str = preg_replace('/\B:-?S\b/i', '{confused}', $str);
    $str = preg_replace('/\B:-?\|/', '{blank}', $str);
    $str = preg_replace('/\B:-?\*+/', '{kiss}', $str);
    $str = preg_replace('/\B:-?\(\B/', '{sad}', $str);
