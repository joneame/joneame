...
do_header(_('mapa de las últimas noticias') . ' | Jonéame');
do_tabs('main', 'map');
...
echo _('publicadas').'&nbsp;<img src="img/geo/publicada.png" width="20" height="25" alt="'._('publicadas').'" title="'._('publicadas').'"/><input type="checkbox" checked="checked"  id="published" onclick="toggle(\'published\')" />';
echo '&nbsp;&nbsp;&nbsp;';
echo _('pendientes').'&nbsp;<img src="img/geo/nueva-noticia.png" width="20" height="25" alt="'._('pendientes').'" title="'._('pendientes').'"/><input type="checkbox" checked="checked"  id="queued" onclick="toggle(\'queued\')" />';
echo '&nbsp;&nbsp;&nbsp;';
echo _('autores').'&nbsp;<img src="img/geo/usuario.png" width="20" height="25" alt="'._('autores').'" title="'._('authors').'"/><input type="checkbox" checked="checked"  id="author" onclick="toggle(\'author\')" />';
